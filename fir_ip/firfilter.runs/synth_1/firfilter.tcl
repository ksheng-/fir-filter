...
read_vhdl -library xil_defaultlib D:/Users/Kevin/Documents/VHDL/firfilter/firfilter.srcs/sources_1/new/firfilter.vhd
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top firfilter -part xc7z020clg484-1


write_checkpoint -force -noxdef firfilter.dcp

catch { report_utilization -file firfilter_utilization_synth.rpt -pb firfilter_utilization_synth.pb }
